...
class TbalonVoley(Tobjeto):
    ...
    def _preparar_imagen(self):
        # --- CAMBIO: Aumentamos visualmente la pelota con un factor sin alterar su física real ---
        factor_visual = 1.5
        ...
        # Ajustamos el grosor de las líneas proporcionalmente para que se vea bien
...
class TVoley(Tsim):
    ...
    def draw(self):
        ...
        # Añadido texto para indicar la cámara lenta
        #txt_slowmo = self.font.render("Simulación al 40% (Cámara Lenta)", True, (150, 50, 50))
        ...
        #self.screen.blit(txt_slowmo, (self.width - 340, 110)) 
...
if __name__ == "__main__":
    ...
    # --- CAMBIO: Velocidad de Simulación para efecto Cámara Lenta ---
    velocidad_simulacion = 0.9  # Corre al 40% del tiempo real
    
    # El delta time se multiplica por el factor, ralentizando la física pero manteniendo los 60 fps
